...
const FACE_MIN_RATIO = 0.35;   // di bawah ini = terlalu jauh (dikalibrasi dari rasio aktual ~0.30)
const FACE_MAX_RATIO = 0.40;   // di atas ini  = terlalu dekat (dikalibrasi: "kedekatan" ~0.37-0.38)
